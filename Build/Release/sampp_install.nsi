...
;General
  ...
  InstallDirRegKey HKCU "Software\sampp" ""
...
!define PRODUCT_WEBSITE "https://github.com/KingHual/SA-MP-Plus"
...
Section "Main Components" SecMain
  ...
  File "sampp_client.asi"
  
  ;Store installation folder
  WriteRegStr HKCU "Software\sampp" "" $INSTDIR
  
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\uninstall_sampp.exe"
  
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninstall_sampp.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\uninstall_sampp.exe"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\sampp_client.asi"

  Delete "$INSTDIR\uninstall_sampp.exe"
  
  DeleteRegKey ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}"

  DeleteRegKey /ifempty HKCU "Software\sampp"
