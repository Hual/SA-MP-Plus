...
unsigned long SystemAddress::ToInteger4( sockaddr_in addr4 )
{
	unsigned int lastHash = SuperFastHashIncremental ((const char*) & addr4.sin_port, sizeof(addr4.sin_port), sizeof(addr4.sin_port) );
	return SuperFastHashIncremental ((const char*) & addr4.sin_addr.s_addr, sizeof(addr4.sin_addr.s_addr), lastHash );
}
